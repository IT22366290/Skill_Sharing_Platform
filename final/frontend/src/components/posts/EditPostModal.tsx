...
const EditPostModal: React.FC<EditPostModalProps> = ({
  ...
  const [imagePreview, setImagePreview] = useState<string | null>(post.postPictureBase64 ? `data:image/jpeg;base64,${post.postPictureBase64}` : null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await skillPostService.updatePost(post.id, {
        userId,
        description: content,
        image: selectedImage
      });
